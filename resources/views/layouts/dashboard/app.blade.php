...
<head>
  ...
  <link rel="stylesheet" href="{{url('/')}}/dashboardFiles/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  ...
  <link rel="stylesheet" href="{{url('/')}}/dashboardFiles/pluginsLTR/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{url('/')}}/dashboardFiles/pluginsLTR/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-flag-o"></i>@lang('site.Change_Language')</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{url('/')}}/dashboardFiles/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{url('/')}}/dashboardFiles/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{url('/')}}/dashboardFiles/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{url('/')}}/dashboardFiles/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{url('/')}}/dashboardFiles/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{url('/')}}/dashboardFiles/dist/img/user1-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{url('/')}}/dashboardFiles/dist/img/user7-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{url('/')}}/dashboardFiles/dist/img/user3-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{url('/')}}/dashboardFiles/dist/img/user5-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{url('/')}}/dashboardFiles/dist/img/user6-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{url('/')}}/dashboardFiles/dist/img/user8-128x128.jpg">
...
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{url('/')}}/dashboardFiles/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
...
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{url('/')}}/dashboardFiles/pluginsLTR/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
